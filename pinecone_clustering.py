...
def fetch_data_in_batches(ids, batch_size=500):
    full_data = []
...
def perform_clustering(data):
    ...
    combined_reduced = pca.fit_transform(features) 
...
plt.savefig("renders/Pinecone clustering.png")
plt.show()